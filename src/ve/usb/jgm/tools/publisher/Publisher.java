...
public class Publisher extends org.apache.tools.ant.Task {
    ...
    public static void main(String[] args) {
        ...
        options.addOption(
            OptionBuilder   .withArgName("library-description")
                            .hasArg()
                            .withDescription("Library description")
                            .withLongOpt("libdescription")
                            .create("l"));
        ...
        try {
            ...
            task.setLibraryDescription(line.getOptionValue("l", "(No description supplied)"));
    ...
    public static void showHelpAndExit() {
        HelpFormatter formatter = new HelpFormatter();
            formatter.printHelp(
                "jdm-publish", 
                "\n" + 
                "JaDiMa Command Line Tools :: Library Publisher v1.0\n" +
                "===================================================\n", 
                options, 
                "\n" + 
    ...
    public void execute() throws BuildException {
        ...
        if (((javadocZipFile == null) && (javadocDir == null)) || ((javadocZipFile != null) && (javadocDir != null))) {
            log("Either javadoc zip file or javadoc dir is required", Project.MSG_ERR);
            throw new BuildException("Either javadoc zip file or javadoc dir is required");
        }
        ...
        try {
            ...
            log("Publishing library " + libraryName + " (version " + majorVersion + "." + minorVersion + "." + revision + ") on repository " + repositoryName, Project.MSG_INFO);
            ...
            log("Library sucessfully published", Project.MSG_INFO);
            ...
            log("Library " + libraryName + " already exists on the " + repositoryName + " repository.", Project.MSG_ERR);
            throw new BuildException("Library " + libraryName + " already exists on the " + repositoryName + " repository", e);
