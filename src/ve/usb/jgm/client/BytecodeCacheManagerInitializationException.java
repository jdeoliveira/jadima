 ...
 */
public class BytecodeCacheManagerInitializationException extends java.lang.Exception {
    
    /**
     * Creates a new instance of <code>RepositoryClientConfigurationException</code> without detail message.
     */
    public BytecodeCacheManagerInitializationException() {
    }
     ...
     */
    public BytecodeCacheManagerInitializationException(String msg, Throwable cause) {
        super(msg, cause);
    }
}
