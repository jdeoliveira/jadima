 ...
 * @author  jdeoliveira
 */
public abstract class StubsCacheManager {
    ...
    public abstract void configure(Element el) throws StubsCacheManagerConfigurationException;
    
    public abstract void init() throws StubsCacheManagerInitializationException;
    
    //TODO: lanzar exception cuando ocurra un error interno
    public abstract Collection<File> getStubs(Collection<Version> version) throws VersionNotFoundException;
