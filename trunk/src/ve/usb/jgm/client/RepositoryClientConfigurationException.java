 ...
 */
public class RepositoryClientConfigurationException extends java.lang.Exception {
    
    /**
     * Creates a new instance of <code>RepositoryClientConfigurationException</code> without detail message.
     */
    public RepositoryClientConfigurationException() {
    }
     ...
     */
    public RepositoryClientConfigurationException(String msg, Throwable cause) {
        super(msg, cause);
    }
}
